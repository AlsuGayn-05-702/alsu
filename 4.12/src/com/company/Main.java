...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (triangleable(l1, l2, l3)){
            ...
            double s = findeSquare(p1, p2, p3);
            System.out.println("Площадь = " + Math.round(s));
        }else {
            System.out.println("Нелзя построить треугольник");
        }
    ...
    public  static  double findeSquare(Point p1, Point p2, Point p3){
